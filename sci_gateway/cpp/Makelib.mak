...
OBJS = sci_transpose.obj test_toolbox.obj
OBJS_WITH_PATH = Release/sci_transpose.obj Release/test_toolbox.obj
# ------------------------------------------------------
# added libraries
FORTRAN_RUNTIME_LIBRARIES = 
OTHERLIBS = E:\Abhinav\Codes\fossee\Scilab6-Test-Toolbox\sci_gateway\cpp\\..\..\thirdparty\windows\lib\libtranspose.lib
# ------------------------------------------------------
!include $(SCIDIR)\modules\dynamic_link\src\scripts\Makefile.incl.mak
# ------------------------------------------------------
#CC = 
# ------------------------------------------------------
CFLAGS = $(CC_OPTIONS) -D__SCILAB_TOOLBOX__ -DFORDLL -D__USE_DEPRECATED_STACK_FUNCTIONS__  -I -w E:\Abhinav\Codes\fossee\Scilab6-Test-Toolbox\sci_gateway\cpp\ -I E:\Abhinav\Codes\fossee\Scilab6-Test-Toolbox\sci_gateway\cpp\\..\..\thirdparty\windows\include  -DNDEBUG -DTEST_TOOLBOX_GW_EXPORTS  
# ------------------------------------------------------
